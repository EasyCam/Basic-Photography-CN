...
| 旁轴相机 | 部分机型可更换           | 1. 尺寸稍小；`<br>`2. 部分机型可更换镜头，适应不同拍摄需求；`<br>`3. 具备较高的画质和拍摄性能。                                             | 1. 取景与拍摄有差异；`<br>`2. 部分机型对焦系统相对不如单反相机。         |
...
| 全画幅 Canon EF, Nikon FX, Sony α, Sony FE, Leica M | 35 mm | 43.3 | 36 | 24 | 3/2 | 864 | 1 |
