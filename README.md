...
| 相机类型 | 镜头是否可更换 | 优势                                                         | 劣势                                                         |
| -------- | -------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 手机     | 不可更换，可外置 | 1. 方便携带，随时随地拍摄；<br>2. 内置多种拍摄模式和滤镜，适合日常拍摄；<br>3. 可通过外置镜头提升拍摄效果。 | 1. 画质相对较低，受限于小传感器；<br>2. 缺乏专业摄影功能和手动控制选项。 |
| 便携相机 | 可更换         | 1. 尺寸小巧，方便携带；<br>2. 可更换镜头，适应不同拍摄需求；<br>3. 具备较高的画质和拍摄性能。 | 1. 镜头选择相对有限；<br>2. 操作界面相对简单，不如单反相机灵活。 |
| 旁轴相机 | 可更换         | 1. 尺寸小巧，方便携带；<br>2. 可更换镜头，适应不同拍摄需求；<br>3. 具备较高的画质和拍摄性能。 | 1. 拍摄速度相对较慢；<br>2. 对焦系统相对简单，不如单反相机准确。 |
| 单反相机 | 可更换         | 1. 具备丰富的镜头选择；<br>2. 高速对焦和连拍功能，适合拍摄运动和野生动物；<br>3. 提供全手动控制选项，满足专业摄影需求。 | 1. 体积较大，不便携带；<br>2. 镜头和配件相对昂贵；<br>3. 操作相对复杂，需要一定的学习成本。 |
| 微单相机 | 可更换         | 1. 尺寸小巧，方便携带；<br>2. 具备较高的画质和拍摄性能；<br>3. 高速对焦和连拍功能，适合拍摄运动和野生动物。 | 1. 镜头选择相对有限；<br>2. 操作界面相对简单，不如单反相机灵活。 |
